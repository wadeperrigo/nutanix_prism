...
module.exports = {
     ...
     * @param {Object} opts Options requires {body:{See Documentation}}.
     * @returns {Promise}
     */
    create: (opts) => {
     ...
     * @param {Object} opts Options requires {uuid:String}
     * @returns {Promise}
     */
    delete: (opts) => {
     ...
     * @param {Object} opts Options requires {itemUUID:String}
     * @returns {Promise}
     */
    getByUUID: (opts) => {
