...
module.exports = {
    ...
    snapshots: {
         ...
         */
        clone: opts => {
            opts.url = `https://${opts.ip}:9440/PrismGateway/services/rest/v2.0/protection_domains/${opts.protectionDomainName}/snapshots/${opts.snapshotID}/clone`
            opts.method = 'POST'
            opts.body = {
                replace: false,
            ...
            if (opts.vmNameArray) opts.body.vmNames = opts.vmNameArray
